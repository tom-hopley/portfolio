class DOM {
  ...
  getTaskHTML = (text, color, id) => {
      ...
      <div class="message-body level">
        ...
        <div class="level-right">
          <div class="level-item">
            <p class="control"> <a data-id="${id}" class="edit-btn button is-inline">Edit</a></p>
          </div>
    ...
    <div class="level-right">
      <div class="level-item">
        <p class="control"> <a data-id="${id}" class="delete-btn button is-inline is-danger">Remove</a></p>
      </div>
    </div>
  </div>
  </article>`;
